...
namespace mountains_of_yendor.XLib
{
    public abstract partial class GameState : DrawableGameComponent
    {
        ...
        {
            Visible = false; Enabled = false; foreach (GameComponent component in childComponents)
            {
                component.Enabled = false; if (component is DrawableGameComponent)
